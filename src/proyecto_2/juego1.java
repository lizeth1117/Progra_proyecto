...
// y los asigna a la matriz de botones del juego, asigna las imagenes correspondientes
    ...
    private void btnEnabled(JButton btn) {
        ...
        if (!caraUp) {                   //caraUp=fasle no hay cartas seleccionadas
            btn.setEnabled(false);       //desabilita el boton de la carta de seleccionada
            Im1 = (ImageIcon) btn.getDisabledIcon();  //guarda la imagen de la carta 1 en una variable
            pbtn[0] = btn;               // guarda el boton en variable 
            caraUp = true;               // se asigna caraUp=true ya que la primera carta fue seleccionada
            primerc = false;            // primero=false indica segunda carta no seleccionada

        } else {                                  // caraup=true la primera carta ya fue seleccionada
            ...
            if (Im1.getDescription().compareTo(Im2.getDescription()) == 0) { //se comparan las 2 imagenes 
                ...
                if (turno == 1) {              // si las imagenes coinciden, aumenta el puntaje del jugador enturno
                    puntajeJugador1 += 20;
                } else {
                    puntajeJugador2 += 20;
                }
...
// vuelve a habilitar los botones de las cartas selecionadas si no coicidieron 
    private void compare() {   
        if (caraUp && primerc) {
            ...
            caraUp = false;
            turno=(turno==1?2:1);  // cambia el turno de los jugadores
        }
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(45, 45, 45)
                        .addComponent(puntos1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
